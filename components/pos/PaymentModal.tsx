...
export function PaymentModal({
  ...
  const handleConfirmPayment = async () => {
    ...
    try {
      ...
      // 2. Create Completed Order record
  ...
  return (
    <Modal visible={visible} animationType="slide" transparent={false} onRequestClose={onClose}>
      <View style={[styles.modalRoot, { backgroundColor: theme.background }]}>
        {/* TOP HEADER */}
        <View style={[styles.topHeader, { borderBottomColor: theme.border, backgroundColor: theme.card }]}>
          <TouchableOpacity activeOpacity={0.7} style={styles.backButton} onPress={onClose}>
            <ArrowLeft size={22} color={theme.text} />
          </TouchableOpacity>

          <View style={styles.headerTitles}>
            <Text style={[styles.headerMainTitle, { color: theme.text }]}>Checkout & Payment</Text>
          ...
          <View style={styles.totalBadge}>
            ...
            <Text style={styles.totalBadgeAmount}>{formatCurrency(finalTotal)}</Text>
          </View>
        </View>
        ...
        {loadingConfigs ? (
          ...
          <View style={[styles.mainLayout, isTablet ? styles.tabletRow : styles.mobileCol]}>
            {/* LEFT / TOP: ORDER SUMMARY & DISCOUNT / TAX BREAKDOWN */}
            <View
              style={[
            ...
            {/* RIGHT / BOTTOM: PAYMENT METHODS TABS & CONTROLS */}
            <View style={styles.paymentSection}>
              {/* Payment Tabs (Cash, QRIS, Transfer, etc.) */}
              <ScrollView
                horizontal
          ...
          <View style={styles.modalOverlay}>
            <View style={[styles.pickerSheet, { backgroundColor: theme.card, borderColor: theme.border }]}>
              <View style={styles.pickerHeader}>
                <Text style={[styles.pickerTitle, { color: theme.text }]}>Select Discount</Text>
